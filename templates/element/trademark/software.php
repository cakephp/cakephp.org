<div id="software" class="col-sm-12 use-soft-trade">
    ...
    <p>
        <strong id="affiliation-uses"
                class="pt-20"><?= __('Use of trademarks to show community affiliation') ?></strong><br>
...
<div class="col-sm-12 hide">
    ...
    <p>
        <strong id="software-license"
                class="pt-20"><?= __('Distribution of modified software') ?></strong><br>
    ...
    <p>
        <strong id="hardware-license"
                class="pt-20"><?= __('Distribution of software preloaded on hardware') ?></strong><br>
