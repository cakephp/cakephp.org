    ...
    <div class="container writers-body">
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 writers-form">
                        ...
                        <div class="form-group">
                            <label for="">
                                <strong><?= __('Proposed article titles') ?></strong> <?= __('(Required)') ?>
                                <br><br>
                            ...
                            <p>
                                <small><?= __('Only original content can be considered, Unfortunately content already posted elsewhere cannot be used.') ?></small>
                            </p>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="g-recaptcha"
                                 data-sitekey="<?= Configure::read('ReCaptcha.site_key') ?>"></div>
        ...
        <?php else : ?>
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-2 writers-form">
                    <form
                        action="//cakedc.us9.list-manage.com/subscribe/post?u=f380de581acd576e7d802552a&amp;id=cd597ea86c"
                        ...
                        <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text"
                                                                                                  name="b_f380de581acd576e7d802552a_cd597ea86c"
                                                                                                  tabindex="-1"
                                                                                                  value="">
                        </div>
                        <button class="writers-btn" type="submit" name="subscribe"
                                id="mc-embedded-subscribe"><?= __('Notify me!') ?></button>
                    </form>
                </div>
                <!--End mc_embed_signup-->
            </div>
