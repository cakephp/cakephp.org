    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center t-team">
                <h1><span
                        class="glyph_range">V</span><?= __('{0} {1}', $this->Html->tag('em', __('The')), $this->Html->tag('strong', __('Bakers'))) ?>
                    <span class="glyph_range">V</span></h1>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title title-modal-team"
                                        id="gridSystemModalLabel"><?= $member['name'] ?></h4>
                                </div>
                                    ...
                                    <?php if (!empty($member['twitter'])) : ?>
                                        <a href="http://twitter.com/<?= $member['twitter'] ?>" target="_blank"
                                           data-toggle="tooltip" title="Twitter"><i
                                                class="fa icon-social fa-twitter"></i></a>
                                    <?php endif; ?>
                                    <?php if (!empty($member['github'])) : ?>
                                        <a href="https://github.com/<?= $member['github'] ?>" target="_blank"
                                           data-toggle="tooltip" title="Github"><i
                                                class="fa icon-social fa-github"></i></a>
                                    <?php endif; ?>
                                    <?php if (!empty($member['mycake'])) : ?>
                                        <a href="http://my.cakephp.org/user/<?= $member['mycake'] ?>"
                                           target="_blank" data-toggle="tooltip" title="My CakePHP"><span
                                                class="glyph_range icon-social">a</span></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
