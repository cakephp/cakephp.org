    ...
    <div class="gray narrowbox mirror gray-pattern">
        <div class="container-fluid docs services">
            ...
            <div class="col-lg-5 col-md-5 col-xs-9 col-lg-push-2 col-md-push-2 text-left">
                <h3>Support</h3>
                <p>Professional support for CakePHP is provided by our professional services partner, the <a href="http://www.cakedc.com/">Cake Development Corporation</a>.</p>
                <p>For more information on professional support for CakePHP, see the <a href="http://www.cakedc.com/">Cake Development Corporation website</a>.</p>
            </div>
        </div>
    </div>
</div>
<div class="main dev" id="training">
    <div class="container-fluid docs services margin-top-max">
        <div class="col-lg-5 col-md-5 col-xs-9 col-xs-push-0 col-lg-push-2 col-md-push-2">
            ...
            <p>Training is provided by the <a href="http://www.cakedc.com/">Cake Development Corporation</a>.</p>
        </div>
    ...
    <div class="gray narrowbox mirror gray-pattern">
        <div class="container-fluid docs services">
            ...
            <div class="col-lg-5 col-md-5 col-xs-9 col-lg-push-2 col-md-push-2 text-left">
                ...
                <p>All these services and more are provided by our professional services provider, the <a href="http://www.cakedc.com/">Cake Development Corporation</a>.</p>
            </div>
        </div>
    </div>
</div>
