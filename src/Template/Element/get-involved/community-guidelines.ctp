...
<div id="comunityguidelinesside" class="col-sm-12 get-developer pt-100">
	...
	<ol>
		...
		<li><?= __('The use of the CakePHP logo and brand assets should follow the instructions available from the logo usage guide: {0}. Following those standards ensures that the visual identity of the framework is never misrepresented or abused.', $this->Html->link('http://cakephp.org/logos', 'http://cakephp.org/logos', ['class' => 't-blue'])) ?></li>
