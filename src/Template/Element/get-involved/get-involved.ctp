...
<div id="getInvolved" class="col-sm-12 pt-35">
	...
	<div id="userSupport" class="box-get">
		...
		<ul>
			<li><?= __('Join the {0} and talk to developers who need help. *', $this->Html->link(__('#cakephp IRC channel, Slack or Discord server'), '#get-help'))?></li>
			<li><?= __(
	...
	<div class="alert ">
		...
		<p><?= __('Additionally, we offer professional training for CakePHP. Sign up to our monthly <a href="https://training.cakephp.org" target="_blank">training sessions</a> sponsored by <a href="https://cakedc.com" target="_blank">CakeDC</a>.')?></p>
	</div>
