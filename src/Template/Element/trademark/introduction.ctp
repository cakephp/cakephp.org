...
<p>
	<?= __('The role of trademarks is to provide assurance about the quality of the products or services with which the
...
<p>
	<?= __('In this Policy we are not trying to limit the lawful use of our trademarks, but rather describe for you what
...
<p>
	<?= __('The sections that follow describe what trademarks are covered by these Guidelines, as well as uses of the
		...
		$this->Html->link(__('Where to get further information'), '#'))?>
</p>