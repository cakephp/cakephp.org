<div class="row">
	<div class="section">
		<h1><?php echo __('CakePHP Logos and Assets')?></h1>
		...
		<h3><?php echo __('Where can I use it?'); ?></h3>
		...
		<h3><?php echo __('Where can\'t I use it?'); ?></h3>
		<p><?php echo sprintf(
		...
		<h3><?php echo __('Logos'); ?></h3>
		<p>
			<img src="/img/logo/cakephp_logo_250_trans.png" />&nbsp;&nbsp;
			<img src="/img/logo/cakephp_logo_125_trans.png" />
		</p>
