<div id="consultation" class="panel">
	...
	<p><?php __('Code Review, performance analysis, security audits and standards reporting are also available.'); ?></p>
	<br/>

	<p><?php echo sprintf(
		__('All these services and more are provided by our professional services provider, the %s.', true),
