<div id="certification" class="panel">
	...
	<br/>
	<p><?php __('Certification ensures you\'ll stand out from the crowd when it comes to job applications.'); ?>
		<?php __('It can also boost your employment value for existing employers, and be a great asset when it comes to salary review.'); ?></p>
	<br/>
	<p><?php __('More information will be available shortly.'); ?></p>
</div>
