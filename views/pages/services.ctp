...
<div id="features" class="tab-container">
	<div style="overflow: visible; display: block; left: 0px;" class="panels">
		<div id="support" class="panel">
			...
			<p>Professional support for CakePHP is provided by our professional services partner, the <a href="http://cakedc.com">Cake Development Corporation</a>.</p>
			<br/>
			<p>For more information on professional support for CakePHP, see the <a href="http://cakedc.com">Cake Development Corporation website</a>.</p>
		</div>

		<div id="training" class="panel">
			<?php echo $html->image('hot-features.png', array('class' => 'image'))?>
			<h2>Training</h2>
			<p>Undertaking CakePHP work within your organization, and wand to ensure your team has the best tools, skills and understanding of the CakePHP Framework and MVC approaches possible? Training for general development, application planning and design, as well as education for preparation before Certification are available.</p>
			<br/>
			<p>Training is provided by the Cake Development Corporation. Visit their site for more information.</p>
			<br/>
			<ul class="features">
				<li><a href="http://cakedc.com">Cake Development Corporation</a></li>
			</ul>
		</div>
		...
		<div id="consultation" class="panel">
			...
			<br/>
			<p>All these services and more are provided by our professional services provider, the <a href="http://cakedc.com">Cake Development Corporation</a></p>
		</div><!--	panel -->
